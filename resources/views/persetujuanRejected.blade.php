<div class="container-fluid p-1 mt-3" style="width: 80%">
    <div class="row">
        <h3><strong>Cuti Rejected</strong></h3>
    </div>
    ...
    <div class="row">
        <table class="table-approval">
            ...
            <tbody>
                @foreach ($cutiRejected as $item => $c)
              <tr>
                <th scope="row">{{ $cutiRejected->firstItem() + $item }}</th>
                <td>
                    @if ($c->karyawan)
                ...
                <td>
                    ...
                    <p>Akhir : <strong style="color: rgb(201, 39, 39)">{{ $c->tanggal_selesai }}</strong></p>
                </td>
                <td>
                ...
                <td>
                  <p>Alasan : {{ $c->alasan }}</p>
                  <p>Alasan Penolakan : {{ $c->alasan_penolakan ?? '' }}</p>
                </td>
                <td>
          ...
          <div class="d-flex flex-column justify-content-center">
            {{ $cutiRejected->links('pagination::bootstrap-5', ['showInfo' => false]) }}
        </div>
        </div>
